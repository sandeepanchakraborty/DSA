...
class Solution {
    ...
    public static int idealArrays(int n, int maxValue) {
        // \U0001f9ee Step 1: Sieve to get smallest prime divisor
        ...
        // \U0001f9f7 Step 2: Precompute binomial coefficients C(n + k - 1, k)
        ...
        // \U0001f501 Step 3: Count ways for each value from 1 to maxValue
        int result = 0;
        for (int i = 1; i <= maxValue; i++) {
            int number = i;
            long ways = 1;

            // \U0001f9e9 Factorize and multiply combinations
            while (number > 1) {
